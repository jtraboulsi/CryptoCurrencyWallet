...
################################################################################
# For this Challenge, we will assume the perspective of a Fintech Finder
...
# "crypto_wallet.py" script contains code for "Fintech Finder’s" customer interface, that will enable us
# to add wallet operations to the application. For this section, we will assume the perspective of a Fintech
# Finder customer (i.e., we’ll provide your Ethereum wallet and account
...
# A single Ether is currently valued at approx. $4180 CAD as of April 2022
candidate_database = {
